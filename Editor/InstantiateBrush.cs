...
namespace InstantiateBrush.Editor
{
    ...
    public class InstantiateBrushWindow : EditorWindow
    {
        ...
        private void SerializedFotter()
        {
            ...
            if (_data.instantiatePalette == null) return;
    ...
    public class InstantiateBrushData : ScriptableObject
    {
        ...
        // Header
        [Tooltip("Object that will contain the instantiated objects. The 'Eraser' only erase child objects of 'Parent Container', whether it was instantiated by the 'Brush' or not.")]
        ...
        // Footer    
        [Tooltip("List of objects that must be instantiated by the 'Brush'; like a palette.")]
